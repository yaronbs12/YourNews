...
function renderSavedDigestDetail(digest) {
  ...
  header.innerHTML = `<strong>Digest #${digest.id}</strong><p class="saved-meta">Created ${createdAt} · ${digest.items.length} items</p>`;
  ...
  elements.savedDigestDetail.append(header, list);
}
